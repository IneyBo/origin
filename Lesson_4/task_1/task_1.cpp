...
class AddressConverter // Класс для чтения и записи адресов
{
private:
    int size = 0;
...
public:
    ...
    void outArrOfAddresses(std::ofstream& fout) // Вывод в файл массива адресов
    {
        fout << size;
        if (size != 0)
        {
...
int main()
{
    ...
    else
    {
        ...
        setOfAddresses.outArrOfAddresses(fout);
